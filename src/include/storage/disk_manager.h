...
class DiskManager {
 public:
   ...
   */
  [[maybe_unused]] void ReadPage(page_id_t logical_page_id, char *page_data);

  /**
   * Write data to specific page
   * Note: page_id = 0 is reserved for free page bit map
   */
  [[maybe_unused]] [[maybe_unused]] void WritePage(page_id_t logical_page_id, const char *page_data);
